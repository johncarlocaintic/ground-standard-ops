# Instruction Worksheet — SOMA MVMT

The build wrote spec-derived DRAFTS into the 2 prose regions of `shared/scripts/closebot/_export/soma-bot-raw.kdl`,
...
```json
{
  "under_18": "no calendar — capture parent contact, tag minor - needs guardian, team follow-up referral, no booking",
  "18_plus": "SOMA MVMT Introduction Class"
}
```
calendars:
```json
{
  "adult": [
    {
      "label": "soma_intro",
      "calendarName": "SOMA MVMT Introduction Class",
      "calendarId": "RxiVRNWlCHsaC3rEVCmi",
      "program": "intro",
      "ageMin": 18,
      "default": true,
      "durationMinutes": 60
