#!/usr/bin/env bash
# Killer B v1.1 full re-sweep on bot_FMMFAFOFG7IG89XI (after teen age-18+ fix).
# Strict sequential to avoid concurrent-sweep contact contamination.
BOT="bot_FMMFAFOFG7IG89XI"
...
SUMMARY="shared/logs/eval/_killerb_v1_1_sweep_summary.txt"
: > "$SUMMARY"
...
for p in adult_mma_default adult_kickboxing kid_5_12 adult_and_kid teen_13_17_nocal under5_redirect minor_self_booking pricing_deflect nonbookable_sparring hostile_aggression; do
  run "$p"
done
