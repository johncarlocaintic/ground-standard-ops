...
SUMMARY="shared/logs/eval/_bodegajj_sweep_summary.txt"
: > "$SUMMARY"
run () {
...
for p in adult_only kid_young kid_older kid_boundary_14 adult_and_kid \
         teen_15_17_nocal under6_redirect gi_not_offered \
