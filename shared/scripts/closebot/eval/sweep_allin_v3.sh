#!/usr/bin/env bash
# All In Jiu-Jitsu v3.0 Agent Node sweep on bot_15WPBGYMS6HLGC5E
...
for p in adult_only kid_young kid_boundary_12 kid_older adult_and_kid teen_13_17_nocal under5_redirect minor_self_booking pricing_deflect nonbookable_alllevels hostile_aggression; do
  run "$p"
done
