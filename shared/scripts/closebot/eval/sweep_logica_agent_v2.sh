#!/usr/bin/env bash
# Phase 3 validation — Logica Agent Node v2.0 (bot_7W616F4BTWVFG84C).
# Same 10 personas + 3x non-det as the classic v1.3 baseline (parity gate).
BOT="bot_7W616F4BTWVFG84C"
...
SUMMARY="shared/logs/eval/_logica_AGENT_v2_sweep.txt"
: > "$SUMMARY"
run () {
...
for p in adult_only kid_youth kid_boundary_13 adult_and_kid teen_14_17_nocal \
         under8_redirect minor_self_booking pricing_deflect \
