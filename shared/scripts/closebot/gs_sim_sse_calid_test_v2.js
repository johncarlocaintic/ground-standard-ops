...
- Your birthday: June 12, 1988. Alice's birthday: September 15, 2015 (she's 10).
...
async function main() {
  ...
  // Conversation
  const PERSONA = "Sammy Johnson, a parent with one daughter Alice (age 10). Wants to book Alice for a trial class at Vacaville Grappling Academy. Casual, friendly, just inquiring.";
