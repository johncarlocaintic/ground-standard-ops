# Instruction Worksheet — Gracie Jiu Jitsu East San Jose

The build wrote spec-derived DRAFTS into the 2 prose regions of `shared/scripts/closebot/_export/graciejjsanjose-bot-raw.kdl`,
...
```json
{
  "adult": "Adult Gracie Combatives",
  "adultId": "t6qNhkiOoAddJddLytLa",
  "kids": [
    {
      "label": "kids_7_13",
      "calendarName": "Kids 7-13 BJJ",
      "calendarId": "XfVsX7id0etaN8pOhDnf",
      "ageMin": 7,
      "ageMax": 13
    }
  ]
